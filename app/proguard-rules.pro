...
-keep,includedescriptorclasses class com.anodyne.app.**$$serializer { *; }
-keepclassmembers class com.anodyne.app.** {
    *** Companion;
}
-keepclasseswithmembers class com.anodyne.app.** {
