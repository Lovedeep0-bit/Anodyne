...
object IconColorStore {
    ...
    private fun applyIconChange(context: Context, iconName: String) {
        ...
        val packageName = context.packageName // The applicationId (com.anodyne.app.debug)
        val componentNamespace = "com.anodyne.app" // The actual namespace where components are defined
